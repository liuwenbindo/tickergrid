...
var url = "http://webservice.gvsi.com/gvsi/xml/getdaily?output=text&symbols=/GHO,/GCL,/BRN&daysback=50&includeheaders=false&fields=symbol,description,last"
...
function getPrice(alltext){
  ...
  thead.append("th").text("Commodity Name");
  thead.append("th").text("Last Price");
  thead.append("th").text("Historical Chart");
